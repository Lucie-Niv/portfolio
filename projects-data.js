...
const PROJECTS_DATA = {
  ...
  graphisme: {
    ...
    projects: [
      {
        id: "agenda-du-ccas",
        title: "Agenda du CCAS — Montfermeil",
        year: 2026,
        mockup: "img/agenda-du-ccas.webp",
        description: `Au cours de mes 2 mois de stage à la mairie de Montfermeil, on m'a confié la mission de prendre en main la refonte de l'agenda du CCAS. Il regroupe une soixantaine d'activités proposées aux habitants de la ville chaque trimestre.\n\nC'est un projet mené en totale autonomie, de la réflexion sur la direction artistique jusqu'à la mise en page complète.\n\nL'objectif : transformer 4 pages A4 en une belle brochure de 16 pages au format A5.\n\nLa première étape a été de constituer un moodboard pour chaque partie de la brochure (couverture, sommaire, mise en page des activités…), afin de définir une direction claire avant de réfléchir à la structure des informations et à l'organisation des 16 pages.\n\nJ’ai commencé la refonte sur le papier, avec des ébauches dessinées dans mon carnet pour la couverture et le format de chaque activité.\nVient ensuite la création de la couverture sur Photoshop, avec 5 versions testées, jusqu'à créer celle validée par la mairie.\nJe suis ensuite passée à la mise en page des activités sur InDesign : création de grilles précises, styles de paragraphe définis pour chaque élément (titre, texte, adresse, dates, etc.), d'abord avec un Lorem Ipsum, puis remplacé par les textes transmis par le CCAS. La même démarche a été appliquée pour le sommaire.\n\nChaque activité a été associée à un thème, conceptualisé à travers 5 pictogrammes originaux, chacun lié à une couleur.\nJ’ai également passé beaucoup de temps pour trouver les bonnes images, dans les archives du serveur de la mairie ou sur des banques d'images libres de droits, afin de sublimer la brochure et d'y ajouter des visuels parlants pour les habitants de Montfermeil.\n\nUne fois la première version transmise aux services concernés, le travail s'est poursuivi avec des ajustements basés sur leurs retours, jusqu'à la version finale.\nVous pouvez maintenant découvrir cette version finale, les étapes du projet, et bien sûr un "Avant/Après" de l'agenda.\n\nCe projet, très formateur, témoigne aussi de la confiance accordée par l'équipe du service communication, et j'en suis très fière.\n\nCe projet m'a permis de :\n\n● Renforcer mes compétences en mise en page et ma maîtrise d'InDesign (grilles, styles de paragraphe),\n● Apprendre à créer des pictogrammes et comprendre l'importance de la cohérence visuelle,\n● Renforcer mes compétences sur Photoshop (masques d'écrêtage en particulier),\n● Comprendre l'importance du choix des images (résolution, taille, droits d'utilisation),\n ● Gagner en confiance dans mes projets.\n\n`,
        competences: ["Créativité", "Design graphique", "Mise en page", "Veille créative"],
        logiciels: [
          { src: "img/illustrator.png", alt: "Illustrator" },
          { src: "img/photoshop.webp",  alt: "Photoshop" },
          { src: "img/indesign.webp",   alt: "Indesign" }
        ],
        lien: "agenda_ccas.pdf"
      },
      {
