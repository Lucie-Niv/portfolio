...
// ===========================================
// Gestion du mode sombre et des Fireflies (Lucioles)
// ===========================================
document.addEventListener('DOMContentLoaded', () => {
    const toggleButton = document.getElementById('dark-mode-toggle');
    const body = document.body;
    
    // Cible TOUS les conteneurs de projet
    const firefliesContainers = document.querySelectorAll('.project-section.fireflies-container'); 
    
    // MODIF : Augmentation du nombre de lucioles (gardé de l'original audiovisuel.js)
    ...
    // 2. Parcourir TOUS les conteneurs pour l'interactivité au survol
    firefliesContainers.forEach(container => {
